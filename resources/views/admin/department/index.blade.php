                ...
                <div class="col-xs-12">
                    <div class="box">
                       <div class="box-header">
                            <h3 class="box-title">{{ __($langFile.'Departments') }}</h3>
                            <a href="{{ route('departments.create') }}" class="btn btn-primary @if(app()->getLocale() == 'en') pull-right @else pull-left @endif">
                                {{ __($langFile.'Create') }}
                            </a>
                       </div>
                        <!-- /.box-header -->
