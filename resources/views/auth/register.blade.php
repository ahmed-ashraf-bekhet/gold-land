                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="register" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('general.Email') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="job" class="col-md-4 col-form-label text-md-right">{{ __('general.Job') }}</label>
                            ...
                            <div class="form-group row mb-0">
                                <div id="submit" class="col-md-6 offset-md-4">
                                    <input type="submit" class="btn" value="{{ __('general.Continue') }}" style="background-color: #cc7a00; color: white;">
                                </div>
                            </div>
                        </form>
                    </div>
